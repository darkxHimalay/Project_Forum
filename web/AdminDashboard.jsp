                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="overview-block">
                            ...
                            <div class="overview-right pull-left">
                                <h4 class="overview-value">No. of up</h4>
                                <span class="overview-title"><h4>Total upvotes</h4></span>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="overview-block">
                        ...
                        <div class="overview-right pull-left">
                           <!-- <h4 class="overview-value">No. of up</h4>
                            <span class="overview-title"><h4>Total upvotes</h4></span>-->
                            <label> PRESS :<input type="button" class="btn btn-group-justified bg-primary" style="width: 100%" value="Delete the Reply"></label>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div>
